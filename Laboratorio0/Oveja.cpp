...
/*! \brief Metodo para que la oveja se mueva en el terreno. Es capaz de moverse
 *         hasta dos espacios en el terrreno siempre que estan desocupados y
 *         sean aledaños.
 *
                ...
                if ((xpos1 >=  0 && xpos1 < Controlador::columns) && (ypos1 >=  0 && ypos1 < Controlador::rows)) {
                    if (Controlador::terreno[ypos1][xpos1]->ocupante.compare("Vacío") == 0) {//busca uno que este vacio
                        if(reproduzcase && !this->alreadyReproduced){
                            ...
                            Controlador::terreno[ypos1][xpos1]->animal = new Oveja(ypos1, xpos1, Controlador::terreno[this->Fila][this->Columna]->animal->Sexo);
